package com.jonathanryangrice.inventorymobile;
...
import static com.jonathanryangrice.inventorymobile.MainApplication.LOG_TAG;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkIntent(@Nullable Intent intent) {
        if (intent != null) {
            ...
            switch (action) {
                case "com.jonathanryangrice.inventorymobile.HANDLE_AUTHORIZATION_RESPONSE":
    ...
    public static class AuthorizeListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String action = "com.jonathanryangrice.inventorymobile.HANDLE_AUTHORIZATION_RESPONSE";
